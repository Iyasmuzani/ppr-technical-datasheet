  ...
  items: [
    ...
    // HDPE SDR 9 (PN20)
    {
      ...
      sizes: [
        ...
        { dn: 32, od: 32, wallThickness: 3.6, weightPerM: 0.3336, pipeLength: 'Coil (300m)' },
        { dn: 40, od: 40, wallThickness: 4.5, weightPerM: 0.5202, pipeLength: 'Coil (50–200m)' },
        { dn: 50, od: 50, wallThickness: 5.6, weightPerM: 0.8061, pipeLength: 'Coil (100m)' },
        { dn: 63, od: 63, wallThickness: 7.1, weightPerM: 1.2862, pipeLength: '6 / 12' },
        { dn: 75, od: 75, wallThickness: 8.4, weightPerM: 1.8078, pipeLength: '12' },
        ...
        { dn: 125, od: 125, wallThickness: 14.0, weightPerM: 5.0114, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 15.7, weightPerM: 6.2780, pipeLength: '12' },
    ...
    // HDPE SDR 11 (PN16)
    {
      ...
      sizes: [
        ...
        { dn: 32, od: 32, wallThickness: 2.9, weightPerM: 0.2836, pipeLength: 'Coil (300m)' },
        { dn: 40, od: 40, wallThickness: 3.7, weightPerM: 0.4369, pipeLength: 'Coil (50–200m)' },
        { dn: 50, od: 50, wallThickness: 4.6, weightPerM: 0.6772, pipeLength: 'Coil (100m)' },
        { dn: 63, od: 63, wallThickness: 5.8, weightPerM: 1.0727, pipeLength: '6 / 12' },
        { dn: 75, od: 75, wallThickness: 6.8, weightPerM: 1.4983, pipeLength: '12' },
        { dn: 90, od: 90, wallThickness: 8.2, weightPerM: 2.1736, pipeLength: '6 / 12' },
        { dn: 110, od: 110, wallThickness: 10.0, weightPerM: 3.2237, pipeLength: '6 / 12' },
        { dn: 125, od: 125, wallThickness: 11.4, weightPerM: 4.1820, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 12.7, weightPerM: 5.2075, pipeLength: '12' },
    ...
    // HDPE SDR 13.6 (PN12.5)
    {
      ...
      image: './assets/products/hdpe-pipe.png',
      sizes: [
        { dn: 50, od: 50, wallThickness: 3.7, weightPerM: 0.5594, pipeLength: 'Coil (100m)' },
        { dn: 63, od: 63, wallThickness: 4.7, weightPerM: 0.8910, pipeLength: '6 / 12' },
        { dn: 75, od: 75, wallThickness: 5.5, weightPerM: 1.2625, pipeLength: '12' },
        { dn: 90, od: 90, wallThickness: 6.6, weightPerM: 1.8087, pipeLength: '6 / 12' },
        { dn: 110, od: 110, wallThickness: 8.1, weightPerM: 2.6793, pipeLength: '6 / 12' },
        { dn: 125, od: 125, wallThickness: 9.2, weightPerM: 3.4526, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 10.3, weightPerM: 4.3237, pipeLength: '12' },
    ...
    // HDPE SDR 17 (PN10)
    {
      ...
      image: './assets/products/hdpe-pipe.png',
      sizes: [
        { dn: 50, od: 50, wallThickness: 3.0, weightPerM: 0.4605, pipeLength: 'Coil (100m)' },
        { dn: 63, od: 63, wallThickness: 3.8, weightPerM: 0.7318, pipeLength: '6 / 12' },
        { dn: 75, od: 75, wallThickness: 4.5, weightPerM: 1.0304, pipeLength: '12' },
        { dn: 90, od: 90, wallThickness: 5.4, weightPerM: 1.4886, pipeLength: '6 / 12' },
        { dn: 110, od: 110, wallThickness: 6.6, weightPerM: 2.2094, pipeLength: '6 / 12' },
        { dn: 125, od: 125, wallThickness: 7.4, weightPerM: 2.8256, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 8.3, weightPerM: 3.5475, pipeLength: '12' },
    ...
    // HDPE SDR 21 (PN8)
    {
      ...
      image: './assets/products/hdpe-pipe.png',
      sizes: [
        { dn: 75, od: 75, wallThickness: 3.6, weightPerM: 0.8376, pipeLength: '12' },
        ...
        { dn: 125, od: 125, wallThickness: 6.0, weightPerM: 2.3149, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 6.7, weightPerM: 2.8935, pipeLength: '12' },
    ...
    // HDPE SDR 26 (PN6.3)
    {
      ...
      sizes: [
        ...
        { dn: 125, od: 125, wallThickness: 4.8, weightPerM: 1.8753, pipeLength: '12' },
        { dn: 140, od: 140, wallThickness: 5.4, weightPerM: 2.3718, pipeLength: '12' },
